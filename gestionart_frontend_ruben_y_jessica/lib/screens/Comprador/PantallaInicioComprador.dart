...
import 'package:gestionart_frontend_ruben_y_jessica/screens/Comprador/Views/pedidos_view.dart';
...
class _PantallainiciocompradorState extends State<Pantallainiciocomprador> {
  List<Widget> get _views => [categorias_inicio_view(comprador: widget.comprador,),PedidosView(comprador: widget.comprador),perfil_view(comprador: widget.comprador)];
  int _currentIndex = 0;
  @override
